        ...
        <div class=\"theme card-item pure-u-1-3 ";
            ...
            if ((($context["state"] ?? null) == "installing")) {
                ...
                if (($this->getAttribute($context["theme"], "premium", []) &&  !$this->getAttribute(($context["admin"] ?? null), "license", [0 => $this->getAttribute($context["theme"], "slug", [])], "method"))) {
                    // line 54
                    echo "                        ";
                    $context["permalink"] = (($this->getAttribute($this->getAttribute($context["theme"], "premium", [], "any", false, true), "permalink", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($context["theme"], "premium", [], "any", false, true), "permalink", []), null)) : (null));
                    // line 55
                    echo "                        ";
...
";
        // line 81
        $this->loadTemplate("partials/modal-switch-theme.html.twig", "partials/themes-list.html.twig", 81)->display($context);
        // line 82
        $this->loadTemplate("partials/modal-add-package.html.twig", "partials/themes-list.html.twig", 82)->display(twig_array_merge($context, ["type" => "theme"]));
        // line 83
        $this->loadTemplate("partials/modal-update-packages.html.twig", "partials/themes-list.html.twig", 83)->display(twig_array_merge($context, ["type" => "theme"]));
    }
                ...
                <div class=\"gpm-actions\">
                    {% if (theme.premium and not admin.license(theme.slug)) %}
                        ...
                        {% if permalink %}
                            ...
                            <a class=\"button\" href=\"{{ final_checkout_url }}\" target=\"_blank\"><i class=\"fa fa-shopping-cart\"></i> {{ theme.premium.button|default('Purchase') }}</a>
                        {% endif %}
                    {% else %}
