...
($context["installing"] ?? null)) {
                ...
                if (($this->getAttribute($context["plugin"], "premium", []) &&  !$this->getAttribute(($context["admin"] ?? null), "license", [0 => $this->getAttribute($context["plugin"], "slug", [])], "method"))) {
                    // line 52
                    echo "                        ";
                    $context["permalink"] = (($this->getAttribute($this->getAttribute($context["plugin"], "premium", [], "any", false, true), "permalink", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($context["plugin"], "premium", [], "any", false, true), "permalink", []), null)) : (null));
                    // line 53
                    echo "                        ";
                    if (($context["permalink"] ?? null)) {
                        // line 54
                        echo "                            ";
                        $context["checkout_url"] = ("https://licensing.getgrav.org/buy/" . ($context["permalink"] ?? null));
                        // line 55
                        echo "                            ";
                        $context["success_url"] = "https://licensing.getgrav.org/portal?checkout=success&checkout_id={CHECKOUT_ID}";
                        // line 56
                        echo "                            ";
                        $context["final_checkout_url"] = ((($context["checkout_url"] ?? null) . "?success_url=") . twig_urlencode_filter(($context["success_url"] ?? null)));
                        // line 57
                        echo "                            <a class=\"button\" href=\"";
                        echo twig_escape_filter($this->env, ($context["final_checkout_url"] ?? null), "html", null, true);
                        echo "\" target=\"_blank\"><i class=\"fa fa-shopping-cart\"></i> ";
            ...
            <td class=\"gpm-details\">
                <div class=\"table-wrapper\">
                    ";
            // line 67
            $this->loadTemplate("partials/plugin-data.html.twig", "partials/plugins-list.html.twig", 67)->display(twig_array_merge($context, ["plugin" => $context["plugin"]]));
            // line 68
            echo "                </div>
            </td>
        </tr>
...
";
        // line 76
        $this->loadTemplate("partials/modal-add-package.html.twig", "partials/plugins-list.html.twig", 76)->display(twig_array_merge($context, ["type" => "plugin"]));
        // line 77
        $this->loadTemplate("partials/modal-update-packages.html.twig", "partials/plugins-list.html.twig", 77)->display(twig_array_merge($context, ["type" => "plugin"]));
        // line 78
        $this->loadTemplate("partials/modal-changelog.html.twig", "partials/plugins-list.html.twig", 78)->display(twig_array_merge($context, ["package" => ($context["plugin"] ?? null)]));
    }
    ...
    {
        return array (  273 => 78,  271 => 77,  269 => 76,  265 => 74,  256 => 72,  240 => 68,  238 => 67,  232 => 63,  229 => 62,  221 => 60,  218 => 59,  210 => 57,  207 => 56,  204 => 55,  201 => 54,  198 => 53,  195 => 52,  192 => 51,  190 => 50,  185 => 48,  178 => 47,  176 => 46,  172 => 44,  168 => 43,  163 => 42,  155 => 38,  152 => 37,  146 => 35,  142 => 33,  139 => 32,  136 => 31,  133 => 30,  127 => 28,  125 => 27,  119 => 26,  115 => 25,  94 => 23,  91 => 22,  88 => 21,  85 => 20,  82 => 19,  79 => 18,  61 => 17,  53 => 12,  46 => 8,  43 => 7,  41 => 6,  37 => 4,  35 => 3,  32 => 2,  30 => 1,);
    }
                ...
                {% elseif (installing) %}
                    {% if (plugin.premium and not admin.license(plugin.slug)) %}
                        ...
                        {% if permalink %}
                            ...
                            <a class=\"button\" href=\"{{ final_checkout_url }}\" target=\"_blank\"><i class=\"fa fa-shopping-cart\"></i> {{ plugin.premium.button|default('Purchase') }}</a>
                        {% endif %}
                    {% else %}
